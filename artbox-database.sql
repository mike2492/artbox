...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 23 juil. 2026 à 12:53
...
--
CREATE DATABASE IF NOT EXISTS `artbox` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `artbox`;
...
INSERT INTO `oeuvres` (`id`, `title`, `description`, `artist`, `image`) VALUES
...
(16, 'Salut', 'Alloooooo', 'Michael', 'https://picsum.photos/200');
COMMIT;
